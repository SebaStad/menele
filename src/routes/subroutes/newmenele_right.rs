...
pub fn section(props: &SectionProps) -> Html {
    ...
    let deref_is_left: bool = if start_left { *is_left } else { !*is_left };
    ...
    let style_string_text = if deref_is_left {
        style_lookup
            .get_style(CssClass::KapitelTextLinks, is_small_window.clone())
            .unwrap()
            .clone()
    } else {
        style_lookup
            .get_style(CssClass::KapitelTextRechts, is_small_window.clone())
            .unwrap()
            .clone()
    };
    ...
    let style_string_image = if deref_is_left {
        style_lookup
            .get_style(CssClass::ImageArtikelRechts, is_small_window.clone())
            .unwrap()
            .clone()
    } else {
        style_lookup
            .get_style(CssClass::ImageArtikelLinks, is_small_window.clone())
            .unwrap()
            .clone()
    };
...
impl SectionData {
    pub fn to_html(&self) -> String {
        ...
        let image_string = format!("<img src=\"{image_url}\">");
